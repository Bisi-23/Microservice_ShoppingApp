pipeline {
    ...
    stages {
            ...
            steps {
              withKubeConfig(caCertificate: '', clusterName: 'myAppp-eks-cluster', contextName: '', credentialsId: 'k8s', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://F34882FB1D0504A5776A8B3ACA667DF6.gr7.us-east-1.eks.amazonaws.com') {
